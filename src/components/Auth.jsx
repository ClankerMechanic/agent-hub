  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full shadow-xl">
        ...
        <form onSubmit={mode === 'signup' ? handleEmailSignUp : mode === 'magic' ? handleMagicLink : handleEmailSignIn} className="space-y-4">
          <div>
            <input
              type="email"
              value={email}
        ...
        <div className="mt-6 text-center text-sm text-gray-400 space-y-2">
          {mode === 'signin' && (
            <>
              ...
              <p>
                <button onClick={() => { setMode('magic'); setError(''); setMessage(''); }} className="text-blue-400 hover:underline">
