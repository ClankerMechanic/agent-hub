export function AppLayout({ leftSidebar, mainContent, rightSidebar, onHomeClick, onSettingsClick, user, onSignOut, onSignIn }) {
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 flex-shrink-0">
        ...
        >
          ...
          <h1 className="text-xl font-bold text-gray-900">Core Agents</h1>
