export function OptionsPanel({ onNewChat, onSettingsClick, onGitHubClick, githubEnabled, syncStatus, darkMode }) {
  return (
    <div className={`p-3 border-b space-y-2 ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
      <button
        onClick={onNewChat}
